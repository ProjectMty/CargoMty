const OrderFulfillment = () => {
  return (
    <section id='order-fulfillment' className='text-justify'>
      ...
      <p>
        We do this through inventory management, meticulously planned logistics,
        strategic locations, and constant communication throughout our team.
      </p>
      <p>
        Enjoy the freedom and the confidence you get when you partner with Cargo
        Monterrey!
      </p>
    </section>
  );
